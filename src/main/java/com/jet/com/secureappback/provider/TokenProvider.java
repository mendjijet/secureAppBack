...
public class TokenProvider {
    ...
    public String createAccessToken(UserPrincipal userPrincipal) {
        return JWT.create().withIssuer(JET_ENTERPRISE_LLC).withAudience(CUSTOMER_MANAGEMENT_SERVICE)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(JET_ENTERPRISE_LLC).build();
